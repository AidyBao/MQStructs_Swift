...
class MQNetwork: NSObject {
    ...
    @discardableResult final class func mq_asyncRequest(withUrl url:String,
                                                               params:Dictionary<String, Any>?,
                                                               method:MQHTTPMethod,
                                                               completion:MQHTTPCompletionAction?,
                                                               timeOut:MQHTTPTimeOutAction?,
                                                               httpError:MQHTTPErrorAction?) -> URLSessionTask? {
        if showRequestLog {
    ...
    ///   - httpError: http request error
    /// - Returns: return value description
    @discardableResult class func mq_uploadImage(to url:String!,
    ...
    @discardableResult class func mq_fileupload(to url:String!,
                                                       name:String,
                                                       fileName:String,
                                                       mimeType:String,
                                                       fileData:Data,
